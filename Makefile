...
writenoncanonical: DataLink.h Application.h Alarm.h Settings.h writenoncanonical.c
	$(CC) writenoncanonical.c DataLink.c Application.c Alarm.c  Settings.c -o writenoncanonical $(CFLAGS)

noncanonical: DataLink.h Application.h Alarm.h Settings.h noncanonical.c
	$(CC) noncanonical.c DataLink.c Application.c Alarm.c Settings.c -o noncanonical $(CFLAGS)
